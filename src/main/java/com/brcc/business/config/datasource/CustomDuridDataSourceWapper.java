...
public class CustomDuridDataSourceWapper extends DruidDataSource implements InitializingBean {


    private DataSourceProperties basicProperties;

    public CustomDuridDataSourceWapper(DataSourceProperties basicProperties){
