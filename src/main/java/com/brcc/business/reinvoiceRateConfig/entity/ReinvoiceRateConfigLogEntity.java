...
@Entity
@Table(name = "reinvoice_rate_config_log")
public class ReinvoiceRateConfigLogEntity implements Serializable{
	
	private static final long serialVersionUID = 1L;
	
	@Id
	@GeneratedValue(strategy = GenerationType.IDENTITY)
	@Column(name = "reinvoice_rate_config_log_id")
	private Long reinvoiceRateConfigLogId;
	...
	public Long getReinvoiceRateConfigLogId() {
		return reinvoiceRateConfigLogId;
	}

	public void setReinvoiceRateConfigLogId(Long reinvoiceRateConfigLogId) {
		this.reinvoiceRateConfigLogId = reinvoiceRateConfigLogId;
	}
